...
public class supplier extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        no_telp_input = new javax.swing.JTextField();
        alamat_input = new javax.swing.JTextField();
        ...
        kode_label.setText("Kode Supplier");
        ...
        no_telp_label.setFont(new java.awt.Font("Leelawadee UI", 1, 14)); // NOI18N
        no_telp_label.setForeground(new java.awt.Color(255, 255, 255));
        no_telp_label.setText("No. Telp");
        card_form.add(no_telp_label, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, -1, -1));

        alamat_label.setFont(new java.awt.Font("Leelawadee UI", 1, 14)); // NOI18N
        alamat_label.setForeground(new java.awt.Color(255, 255, 255));
        alamat_label.setText("Alamat");
        card_form.add(alamat_label, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 140, -1, -1));
        ...
        card_form.add(no_telp_input, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 100, 210, -1));
        card_form.add(alamat_input, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 140, 210, 70));
    ...
    // < Buttons >
        ...
        private void button_editActionPerformed(java.awt.event.ActionEvent evt) {
            ...
            if (!"0".equals(row_id)) {
                ...
                try {
                    ...
                    String sql = "SELECT supplier.id_supplier, supplier.kode_supplier, supplier.nama_supplier, supplier.alamat_supplier, supplier.no_telp_supplier FROM supplier WHERE supplier.id_supplier ='"+ row_id +"'";
                    ...
                    if (res.next()) {
                        ...
                        String code_name = res.getString("nama_supplier");

                        form_title.setForeground(Color.white);
                        form_title.setText("Editing Data | " + code_name);
                        id_input.setText(res.getString("id_supplier"));
                        kode_input.setText(res.getString("kode_supplier"));
                        nama_input.setText(code_name);
                        alamat_input.setText(res.getString("alamat_supplier"));
                        no_telp_input.setText(res.getString("no_telp_supplier"));
                        kode_input.requestFocus();
        ...
        private void button_deleteActionPerformed(java.awt.event.ActionEvent evt) {
            ...
            if (valid == 0) {
                ...
                try {
                    ...
                    String row_id = id_input.getText();
                    String sql = "DELETE FROM supplier WHERE id_supplier = '"+ row_id + "'";
        ...
        private void button_saveActionPerformed(java.awt.event.ActionEvent evt) {
            ...
            String row_alamat = alamat_input.getText();
            String row_no_telp = no_telp_input.getText();
            
                int code = 0;

                if (!"".equals(row_kode) && !"".equals(row_kode) && !"".equals(row_nama) && !"".equals(row_alamat) && !"".equals(row_no_telp)) {

                    try {

                        String sql = "SELECT COUNT(supplier.id_supplier) as count FROM supplier WHERE supplier.kode_supplier = '"+ row_kode +"'";
                    ...
                    if ("".equals(row_id)) {
                        ...
                        if (code == 0) {
                            ...
                            try {
                                ...
                                String sql = "INSERT INTO supplier(kode_supplier, nama_supplier, no_telp_supplier, alamat_supplier) VALUES ('"+ row_kode +"', '"+ row_nama +"', '"+ row_no_telp +"', '"+ row_alamat +"')";
                            ...
                            JOptionPane.showMessageDialog(null, "Supplier code have ever been stored before.", "Failed to attempt", JOptionPane.ERROR_MESSAGE);
                        ...
                        if (code == 0 || row_id.equals(row_id)) {
                            ...
                            try {
                                ...
                                String sql = "UPDATE supplier SET kode_supplier='"+ row_kode +"', nama_supplier='"+ row_nama +"', alamat_supplier='"+ row_alamat +"', no_telp_supplier='"+ row_no_telp +"' WHERE id_supplier = '"+ row_id +"' ";
    ...
    private javax.swing.JTextField alamat_input;
    ...
    private javax.swing.JTextField no_telp_input;
