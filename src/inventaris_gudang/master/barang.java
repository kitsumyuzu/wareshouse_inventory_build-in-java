...
public class barang extends javax.swing.JDialog {
    ...
    private void cleaner() {
        ...
        satuan_input.setText(null);
        stock_input.setText(null);
        id_input.setText(null);
        id_kategori_input.setText(null);;
        kategori_input.setSelectedItem("-- Pilih --");
        ...
        try {
            ...
            String sql = "SELECT * FROM kategori";
                ...
                java.sql.ResultSet res = stm.executeQuery(sql);
                    ...
                    kategori_input.addItem("-- Pilih --");

                    while (res.next()) {

                        kategori_input.addItem(res.getString("nama_kategori"));

                    }

        } catch (Exception e) {

            System.out.println("Error occurate: " + e.getMessage());
    ...
    private void initComponents() {
        ...
        satuan_label = new javax.swing.JLabel();
        button_save = new javax.swing.JButton();
        button_cancel = new javax.swing.JButton();
        satuan_input = new javax.swing.JTextField();
        kategori_input = new javax.swing.JComboBox<String>();
        ...
        id_kategori_input = new javax.swing.JTextField();
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "#", "Kode", "Nama", "Kategori", "Satuan", "Stock"
            }
        ) {
        ...
        kode_label.setText("Kode Barang");
        card_form.add(kode_label, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, -1, -1));
        card_form.add(kode_input, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 20, 210, -1));

        nama_label.setFont(new java.awt.Font("Leelawadee UI", 1, 14)); // NOI18N
        nama_label.setForeground(new java.awt.Color(255, 255, 255));
        nama_label.setText("Nama Barang");
        card_form.add(nama_label, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, -1, -1));
        card_form.add(nama_input, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 60, 210, -1));

        kategori_label.setFont(new java.awt.Font("Leelawadee UI", 1, 14)); // NOI18N
        kategori_label.setForeground(new java.awt.Color(255, 255, 255));
        kategori_label.setText("Kategori");
        card_form.add(kategori_label, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, -1, -1));

        satuan_label.setFont(new java.awt.Font("Leelawadee UI", 1, 14)); // NOI18N
        satuan_label.setForeground(new java.awt.Color(255, 255, 255));
        satuan_label.setText("Satuan");
        card_form.add(satuan_label, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 140, -1, -1));
        ...
        card_form.add(button_save, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 230, 130, -1));
        ...
        card_form.add(button_cancel, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 230, -1, -1));
        card_form.add(satuan_input, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 140, 210, -1));

        kategori_input.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                kategori_inputItemStateChanged(evt);
            }
        });
        card_form.add(kategori_input, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 100, 210, -1));

        stock_label.setFont(new java.awt.Font("Leelawadee UI", 1, 14)); // NOI18N
        stock_label.setForeground(new java.awt.Color(255, 255, 255));
        stock_label.setText("Stock");
        card_form.add(stock_label, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 180, -1, -1));
        card_form.add(stock_input, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 180, 210, -1));
            ...
            .addGroup(contentLayout.createSequentialGroup()
                ...
                .addGroup(contentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(contentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addComponent(id_kategori_input, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGroup(contentLayout.createSequentialGroup()
            ...
            .addGroup(contentLayout.createSequentialGroup()
                ...
                .addGroup(contentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(contentLayout.createSequentialGroup()
                        ...
                        .addComponent(card_form, javax.swing.GroupLayout.PREFERRED_SIZE, 287, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(id_kategori_input, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(12, 12, 12)
                .addGroup(contentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(contentLayout.createSequentialGroup()
                        .addGap(4, 4, 4)
    ...
    // < Buttons >
        ...
        private void button_editActionPerformed(java.awt.event.ActionEvent evt) {
            ...
            if (!"0".equals(row_id)) {
                ...
                try {
                    ...
                    String sql = "SELECT barang.id_barang, barang.kode_barang, barang.nama_barang, barang.id_kategories, kategori.nama_kategori as kategori, barang.satuan_barang, barang.stock_barang FROM barang JOIN kategori ON kategori.id_kategori = barang.id_kategories WHERE barang.id_barang ='"+ row_id +"'";
                    ...
                    if (res.next()) {
                        ...
                        String code_name = res.getString("nama_barang");

                        form_title.setForeground(Color.white);
                        form_title.setText("Editing Data | " + code_name);
                        id_input.setText(res.getString("id_barang"));
                        kode_input.setText(res.getString("kode_barang"));
                        nama_input.setText(code_name);
                        kategori_input.setSelectedItem(res.getString("kategori"));
                        id_kategori_input.setText(res.getString("id_kategories"));
                        satuan_input.setText(res.getString("satuan_barang"));
                        stock_input.setText(res.getString("stock_barang"));
                        kode_input.requestFocus();
        ...
        private void button_deleteActionPerformed(java.awt.event.ActionEvent evt) {
            ...
            if (valid == 0) {
                ...
                try {
                    ...
                    String row_id = id_input.getText();
                    String sql = "DELETE FROM barang WHERE id_barang = '"+ row_id + "'";
        ...
        private void button_saveActionPerformed(java.awt.event.ActionEvent evt) {
            ...
            String row_id = id_input.getText();
            String row_kode = kode_input.getText();
            String row_nama = nama_input.getText();
            String id_kategori = id_kategori_input.getText();
            int row_kategori = Integer.parseInt(id_kategori);
            String row_satuan = satuan_input.getText();
            String stock_barang = stock_input.getText();
            int row_stock = Integer.parseInt(stock_barang);
            
                int code = 0;

                if (!"".equals(row_kode) && !"".equals(row_nama) && !"".equals(row_kategori) && !"".equals(row_satuan) && !"".equals(row_stock)) {

                    try {

                        String sql = "SELECT COUNT(barang.id_barang) as count FROM barang WHERE barang.kode_barang='"+ row_kode +"'";
                    ...
                    if ("".equals(row_id)) {
                        ...
                        if (code == 0) {
                            ...
                            try {
                                ...
                                String sql = "INSERT INTO barang(kode_barang, nama_barang, id_kategories, satuan_barang, stock_barang) VALUES('"+ row_kode +"', '"+ row_nama +"', '"+ row_kategori +"', '"+ row_satuan +"', '"+ row_stock +"')";
                            ...
                            JOptionPane.showMessageDialog(null, "Items code have ever been stored before.", "Failed to attempt", JOptionPane.ERROR_MESSAGE);
                        ...
                        if (code == 0 || row_id.equals(row_id)) {
                            ...
                            try {
                                ...
                                String sql = "UPDATE barang SET kode_barang='"+ row_kode +"', nama_barang='"+ row_nama +"', id_kategories='"+ row_kategori +"', satuan_barang='"+ row_satuan +"', stock_barang='"+ row_stock +"' WHERE id_barang = '"+ row_id +"' ";
        ...
        private void kategori_inputItemStateChanged(java.awt.event.ItemEvent evt) {

            String sl_kategori = kategori_input.getSelectedItem().toString();

                if (!sl_kategori.equals("")) {

                    try {

                        String sql = "SELECT id_kategori FROM kategori WHERE nama_kategori='"+ sl_kategori +"' ";
                            ...
                            if (res.next()) {
                                ...
                                id_kategori_input.setText(res.getString("id_kategori"));
    ...
    private javax.swing.JTextField id_kategori_input;
    private javax.swing.JLabel id_label;
    private javax.swing.JScrollPane jScrollPane2;
    private javax.swing.JLabel jumlah_label;
    private javax.swing.JComboBox<String> kategori_input;
    ...
    private javax.swing.JTextField satuan_input;
    private javax.swing.JLabel satuan_label;
