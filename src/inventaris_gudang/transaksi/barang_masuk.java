...
public class barang_masuk extends javax.swing.JDialog {

    public barang_masuk(java.awt.Frame parent, boolean modal) {
    ...
    public void load_table() {
        ...
        try {
            ...
            String sql = "SELECT barang_masuk.id_barang_masuk, barang_masuk.tanggal_barang_masuk, barang_masuk.total_barang_masuk, barang.nama_barang as barang FROM barang_masuk JOIN barang ON barang.id_barang = barang_masuk.barang";
    ...
    private void initComponents() {
        ...
        title.setText("Data Barang Masuk");
        ...
        tgl_masuk_label.setText("Tanggal Masuk");
        ...
        total_label.setText("Total Masuk");
    ...
    private void button_printActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_printActionPerformed
        ...
        try {
            ...
            String path =  "src/report/report_barang_masuk.jasper";
            java.sql.Connection con = (Connection) db_connection.configDB();
        ...
        private void button_deleteActionPerformed(java.awt.event.ActionEvent evt) {
            ...
            if (valid == 0) {
                ...
                try {
                    ...
                    String sql = "DELETE FROM barang_masuk WHERE id_barang_masuk = '"+ row_id + "'";
            ...
            int row_barang = Integer.parseInt(id_barang);
                ...
                if (!"".equals(row_total) && !"".equals(row_barang)) {
                    ...
                    try {
                        ...
                        String sql = "SELECT COUNT(barang_masuk.barang) as count FROM barang_masuk WHERE barang_masuk.barang='"+ row_barang +"'";
                    ...
                    if ("".equals(row_id)) {
                        ...
                        if (code == 0) {
                            ...
                            try {
                                ...
                                String sql = "INSERT INTO barang_masuk(tanggal_barang_masuk, total_barang_masuk, barang) VALUES('"+ row_tanggal +"', '"+ row_total +"', '"+ row_barang +"')";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                barang_masuk dialog = new barang_masuk(new javax.swing.JFrame(), true);
